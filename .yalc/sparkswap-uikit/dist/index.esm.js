...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 220 50" }, props),
        React.createElement("image", { width: "220", height: "50", href: "/images/logo-menu-light.png" })));
};
...
var NavHeaderEntry = styled.div(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), MENU_ENTRY_HEIGHT, function (_a) {
...
var HeaderNavAccordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        ...
        React.createElement(AccordionContent, { isOpen: isOpen, maxHeight: (React.Children.count(children) + 8) * MENU_ENTRY_HEIGHT + 32 }, children)));
};
...
var HeaderNav = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry, index) {
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React.createElement(HeaderNavAccordion$1, { isOpen: openAccordionIndex === index, handleClick: function () { return handleClick(index); }, key: entry.label, label: entry.label, className: calloutClass }, entry.items.map(function (item) { return (React.createElement(NavHeaderEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname }, item.openTab ? (React.createElement(NavLinkHeader, { target: "_blank", href: item.href }, item.label)) : (React.createElement(NavLinkHeader, { href: item.href }, item.label)))); })));
        }
...
var Footer = function () {
    return React.createElement(Container$4, null, "Footer");
};
...
styled(Overlay)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { scrolled: scrolled },
            React.createElement(Logo$1, { href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(HeaderNav, { links: links, isMobile: isMobile }),
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, login: login, logout: logout }),
                profile && React.createElement(Avatar, { profile: profile }))),
        React.createElement(BodyWrapper, null, children),
