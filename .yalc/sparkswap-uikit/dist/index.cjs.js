...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 220 50" }, props),
        React__default['default'].createElement("image", { width: "220", height: "50", href: "/images/logo-menu-light.png" })));
};
...
var NavHeaderEntry = styled__default['default'].div(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), MENU_ENTRY_HEIGHT, function (_a) {
...
var HeaderNavAccordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        ...
        React__default['default'].createElement(AccordionContent, { isOpen: isOpen, maxHeight: (React__default['default'].Children.count(children) + 8) * MENU_ENTRY_HEIGHT + 32 }, children)));
};
...
var HeaderNav = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry, index) {
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React__default['default'].createElement(HeaderNavAccordion$1, { isOpen: openAccordionIndex === index, handleClick: function () { return handleClick(index); }, key: entry.label, label: entry.label, className: calloutClass }, entry.items.map(function (item) { return (React__default['default'].createElement(NavHeaderEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname }, item.openTab ? (React__default['default'].createElement(NavLinkHeader, { target: "_blank", href: item.href }, item.label)) : (React__default['default'].createElement(NavLinkHeader, { href: item.href }, item.label)))); })));
        }
...
var Footer = function () {
    return React__default['default'].createElement(Container$4, null, "Footer");
};
...
var StyledNav = styled__default['default'].nav(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  position: sticky;\n  top: 0;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 30px;\n  padding-right: 30px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 20;\n"], ["\n  position: sticky;\n  top: 0;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 30px;\n  padding-right: 30px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 20;\n"])), MENU_HEIGHT, function (_a) {
    var theme = _a.theme, scrolled = _a.scrolled;
    return (scrolled ? theme.colors.headerBackground : "transparent");
});
...
styled__default['default'](Overlay)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, links = _a.links, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { scrolled: scrolled },
            React__default['default'].createElement(Logo$1, { href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React__default['default'].createElement(HeaderNav, { links: links, isMobile: isMobile }),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout }),
                profile && React__default['default'].createElement(Avatar, { profile: profile }))),
        React__default['default'].createElement(BodyWrapper, null, children),
        React__default['default'].createElement(Footer$1, null)));
};
var templateObject_1$F, templateObject_2$d, templateObject_3$6, templateObject_4$2;
