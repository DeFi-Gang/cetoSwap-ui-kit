...
}, getButtonVariantProp("backgroundHover"), getButtonVariantProp("borderColorHover"), getButtonVariantProp("backgroundActive"), getButtonVariantProp("boxShadowActive"), getDisabledStyles, removePointerEvents, styledSystem.space);
...
var Icon$7 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 13 8" }, props),
        React__default['default'].createElement("path", { d: "M1.81836 6.66699L6.81836 1.66699L11.8184 6.66699", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
};

var Icon$8 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 13 8" }, props),
        React__default['default'].createElement("path", { d: "M11.6504 1.33301L6.65039 6.33301L1.65039 1.33301", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
};
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 92 40" }, props),
        React__default['default'].createElement("image", { width: "92", height: "40", href: "/images/logo.png" })));
};
    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$k, { width: "24px", color: "white" }))))));
};
...
var getBoxShadow = function (_a) {
    var isActive = _a.isActive, isSuccess = _a.isSuccess, isWarning = _a.isWarning, isDisabled = _a.isDisabled, theme = _a.theme;
    if (isWarning) {
...
}, getBorderColor, styledSystem.space);
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#050317", backgroundDisabled: "#0D095A", contrast: "#241326", invertedContrast: "#FFFFFF", input: "#0D095A", tertiary: "#f4eff5", text: "#FFFFFF", textDisabled: "#c0bdc4", textSubtle: "#B8B6CB", borderColor: "#eae9eb", card: "#0F0749", headerBackground: "#01060A", gradients: {
...
var Radio = styled__default['default'].input.attrs({ type: "radio" })(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 50%;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    border-radius: 50%;\n    content: \"\";\n    height: ", ";\n    left: 6px;\n    position: absolute;\n    top: 6px;\n    width: ", ";\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      background-color: ", ";\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n  ", "\n"], ["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 50%;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    border-radius: 50%;\n    content: \"\";\n    height: ", ";\n    left: 6px;\n    position: absolute;\n    top: 6px;\n    width: ", ";\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      background-color: ", ";\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n  ", "\n"])), getScale$1, getScale$1, function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.primary;
}, lightColors.text, styledSystem.space);
Radio.defaultProps = {
    scale: scales$2.MD,
    m: 0,
};
...
var StyledToggle = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 24px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 52px;\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 24px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 52px;\n"])), function (_a) {
    ...
    return theme.colors[checked ? "primary" : "background"];
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
});
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$5, { color: "white" }))),
                React__default['default'].createElement(Heading, null, title)),
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", size: "sm", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$k, { color: "white", width: 24 })))),
...
var Logo = function (_a) {
    var href = _a.href, isFooter = _a.isFooter;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = React__default['default'].createElement(Icon$q, { width: isFooter ? 171 : 92 });
    return (React__default['default'].createElement(React__default['default'].Fragment, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://manta.socialscan.io/address/" + account, mr: "16px" }, "View on Explorer"),
...
var MobileMenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (isActive ? theme.colors.primaryBright : theme.colors.primaryBright);
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.backgroundDisabled;
...
var MobileAccordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MobileMenuEntry, { onClick: handleClick, className: className },
        ...
        React__default['default'].createElement(AccordionContent, { isOpen: isOpen, maxHeight: React__default['default'].Children.count(children) * (MENU_ENTRY_HEIGHT + 8) + 16 }, children)));
};
...
var StyledAvatar = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
...
var StyledPanel = styled__default['default'].div(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  position: fixed;\n  top: ", "px;\n  right: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: calc(100vh - ", "px);\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  padding: ", ";\n"], ["\n  position: fixed;\n  top: ", "px;\n  right: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: calc(100vh - ", "px);\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  padding: ", ";\n"])), MENU_HEIGHT, function (_a) {
    ...
    return (showMenu ? SIDEBAR_WIDTH_FULL + "px" : 0);
}, MENU_HEIGHT, function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? "initial" : "hidden");
}, function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? "16px 0" : 0);
});
var StyledFlex = styled__default['default'].div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"], ["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"])));
var MobileMenuSideBar = function (props) {
    var showMenu = props.showMenu, account = props.account, login = props.login, logout = props.logout, profile = props.profile;
    return (React__default['default'].createElement(StyledPanel, { showMenu: showMenu },
        React__default['default'].createElement(MobileMenuBody, __assign({}, props)),
...
var NavHeaderEntry = styled__default['default'].div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), function (_a) {
    var isInAccordion = _a.isInAccordion;
    return (isInAccordion ? "16px" : 0);
}, MENU_ENTRY_HEIGHT, function (_a) {
    var theme = _a.theme, isActive = _a.isActive;
    return (isActive ? theme.colors.primary : theme.colors.tertiary);
}, function (_a) {
    var theme = _a.theme, isActive = _a.isActive;
    return (isActive ? theme.colors.primaryBright : theme.colors.primaryBright);
}, function (_a) {
...
var AccordionContent$1 = styled__default['default'].div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out, padding 0.3s ease-in;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  position: absolute;\n  z-index: 22;\n  border-radius: 4px;\n  min-width: 220px;\n  top: 50px;\n  overflow: hidden;\n  background-color: ", ";\n  padding: ", ";\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out, padding 0.3s ease-in;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  position: absolute;\n  z-index: 22;\n  border-radius: 4px;\n  min-width: 220px;\n  top: 50px;\n  overflow: hidden;\n  background-color: ", ";\n  padding: ", ";\n"])), function (_a) {
    var isOpen = _a.isOpen, maxHeight = _a.maxHeight;
    return (isOpen ? maxHeight + "px" : 0);
}, function (_a) {
    var theme = _a.theme;
...
var HeaderNav = function (_a) {
    ...
    var _b = React.useState(null), openAccordionIndex = _b[0], setOpenAccordionIndex = _b[1];
    var handleClick = React.useCallback(function (index, fromAccordion) {
...
var LogoFooter = function (_a) {
    var props = __rest(_a, []);
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 171 74" }, props),
        React__default['default'].createElement("image", { width: "171", height: "74", href: "/images/logo.png" })));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 33" }, props),
        React__default['default'].createElement("path", { d: "M15.9253 0.220747C11.6948 0.240489 7.64431 1.93491 4.65986 4.93336C1.67541 7.9318 -4.60654e-05 11.9902 9.54606e-10 16.2207C9.54613e-10 20.4642 1.68571 24.5339 4.68629 27.5345C7.68687 30.535 11.7565 32.2207 16 32.2207C20.2435 32.2207 24.3131 30.535 27.3137 27.5345C30.3143 24.5339 32 20.4642 32 16.2207C32 11.9773 30.3143 7.90762 27.3137 4.90704C24.3131 1.90646 20.2435 0.220747 16 0.220747C15.9751 0.220689 15.9502 0.220689 15.9253 0.220747ZM22.5413 9.85275C22.6747 9.85008 22.9693 9.88341 23.1613 10.0394C23.2889 10.1502 23.3703 10.3048 23.3893 10.4727C23.4107 10.5967 23.4373 10.8807 23.416 11.1021C23.176 13.6327 22.1333 19.7714 21.6027 22.6047C21.3787 23.8047 20.9373 24.2061 20.5093 24.2447C19.5813 24.3314 18.876 23.6314 17.976 23.0421C16.568 22.1181 15.772 21.5434 14.4053 20.6421C12.8253 19.6021 13.8493 19.0287 14.7493 18.0954C14.9853 17.8501 19.0787 14.1261 19.1587 13.7887C19.168 13.7461 19.1773 13.5887 19.084 13.5061C18.9907 13.4234 18.852 13.4514 18.752 13.4741C18.6107 13.5061 16.3613 14.9941 12.004 17.9341C11.364 18.3741 10.7867 18.5874 10.268 18.5741C9.69733 18.5634 8.59867 18.2527 7.78133 17.9874C6.77867 17.6607 5.98267 17.4887 6.052 16.9354C6.088 16.6474 6.48533 16.3527 7.24267 16.0514C11.9067 14.0194 15.016 12.6794 16.5733 12.0327C21.016 10.1847 21.94 9.86341 22.5413 9.85275Z", fill: "white" })));
};
...
var Icon$$ = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 33", fill: "none" }, props),
        React__default['default'].createElement("path", { d: "M16 32.2207C24.8366 32.2207 32 25.0573 32 16.2207C32 7.38415 24.8366 0.220703 16 0.220703C7.16344 0.220703 0 7.38415 0 16.2207C0 25.0573 7.16344 32.2207 16 32.2207Z", fill: "white" }),
        React__default['default'].createElement("path", { d: "M7.43666 7.44717C7.57938 7.44717 7.65652 7.44717 7.7356 7.44717C9.25537 7.44717 10.7771 7.4491 12.2968 7.44331C12.4762 7.44331 12.5842 7.49731 12.6864 7.64968C14.102 9.72297 15.5254 11.7924 16.9699 13.8946C17.1937 13.6381 17.4077 13.3932 17.618 13.1482C19.1975 11.3102 20.779 9.47417 22.3528 7.63232C22.4704 7.49539 22.5861 7.43946 22.7636 7.44524C23.1628 7.45681 23.562 7.4491 24.021 7.4491C23.7356 7.78469 23.4907 8.07591 23.2438 8.36328C21.4425 10.4578 19.6411 12.5542 17.834 14.6429C17.6893 14.8107 17.6662 14.9207 17.8012 15.1154C20.0133 18.3228 22.2178 21.5378 24.4241 24.7509C24.4685 24.8146 24.509 24.8821 24.5688 24.9766C24.4762 24.9843 24.4106 24.9959 24.345 24.9959C22.8253 24.9959 21.3036 24.9901 19.7838 24.9997C19.562 25.0017 19.4328 24.9322 19.3055 24.7471C17.8417 22.5966 16.3682 20.4539 14.8947 18.3093C14.8696 18.2726 14.8388 18.2398 14.7964 18.1897C14.4453 18.5947 14.102 18.992 13.7587 19.3912C12.2081 21.1945 10.6556 22.9978 9.11072 24.8049C8.98729 24.9477 8.86192 25.0074 8.67484 25.0017C8.28526 24.9882 7.89374 24.9978 7.4328 24.9978C9.68738 22.3749 11.9034 19.7982 14.1329 17.2042C11.9111 13.966 9.69317 10.7336 7.43666 7.44717ZM22.5167 23.9023C22.4396 23.7885 22.3952 23.723 22.3489 23.6574C20.7829 21.4144 19.2168 19.1714 17.6507 16.9284C15.7452 14.2013 13.8417 11.4761 11.9304 8.75479C11.8687 8.66607 11.7202 8.59085 11.6102 8.58892C10.9854 8.57349 10.3586 8.58121 9.73174 8.58314C9.66617 8.58314 9.60059 8.59278 9.50802 8.6005C9.56395 8.68536 9.60059 8.74515 9.6411 8.80301C11.2129 11.0518 12.7848 13.3025 14.3566 15.5513C16.2563 18.2707 18.156 20.9882 20.0596 23.7037C20.1194 23.7885 20.2293 23.8888 20.3181 23.8908C21.0336 23.9101 21.7472 23.9023 22.5167 23.9023Z", fill: "#050317" })));
};
...
var Icon$19 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 33" }, props),
        React__default['default'].createElement("rect", { y: "0.220703", width: "32", height: "32", rx: "16", fill: "white" }),
        React__default['default'].createElement("path", { d: "M14 19.2207L19.19 16.2207L14 13.2207V19.2207ZM25.56 11.3907C25.69 11.8607 25.78 12.4907 25.84 13.2907C25.91 14.0907 25.94 14.7807 25.94 15.3807L26 16.2207C26 18.4107 25.84 20.0207 25.56 21.0507C25.31 21.9507 24.73 22.5307 23.83 22.7807C23.36 22.9107 22.5 23.0007 21.18 23.0607C19.88 23.1307 18.69 23.1607 17.59 23.1607L16 23.2207C11.81 23.2207 9.2 23.0607 8.17 22.7807C7.27 22.5307 6.69 21.9507 6.44 21.0507C6.31 20.5807 6.22 19.9507 6.16 19.1507C6.09 18.3507 6.06 17.6607 6.06 17.0607L6 16.2207C6 14.0307 6.16 12.4207 6.44 11.3907C6.69 10.4907 7.27 9.9107 8.17 9.6607C8.64 9.5307 9.5 9.4407 10.82 9.3807C12.12 9.3107 13.31 9.2807 14.41 9.2807L16 9.2207C20.19 9.2207 22.8 9.3807 23.83 9.6607C24.73 9.9107 25.31 10.4907 25.56 11.3907Z", fill: "#050317" })));
};

var Icon$1a = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 33" }, props),
        React__default['default'].createElement("rect", { y: "0.220703", width: "32", height: "32", rx: "16", fill: "white" }),
        React__default['default'].createElement("g", { clipPath: "url(#clip0_440_1792)" },
            React__default['default'].createElement("path", { d: "M19.4 7.2207C19.1621 7.64679 18.9501 8.08683 18.7651 8.53842C16.9476 8.25098 15.0961 8.25098 13.2786 8.53842C13.0936 8.08683 12.8816 7.64679 12.6437 7.2207C10.9316 7.51324 9.26723 8.03713 7.69627 8.778C4.88707 12.8321 3.61307 17.754 4.1025 22.662C5.93321 24.0382 7.98791 25.0878 10.176 25.7646C10.6742 25.1064 11.1189 24.4094 11.5057 23.6802C10.7918 23.417 10.1057 23.0839 9.45722 22.6859C9.63506 22.5676 9.8033 22.4354 9.96035 22.2906C11.8512 23.2014 13.923 23.6744 16.0218 23.6744C18.1206 23.6744 20.1925 23.2014 22.0833 22.2906C22.2511 22.4343 22.4188 22.5661 22.5865 22.6859C21.9345 23.0808 21.2491 23.4175 20.538 23.6922C20.9088 24.4379 21.3416 25.1512 21.8318 25.8245C24.0171 25.1501 26.0683 24.1002 27.8933 22.7218C28.3945 17.813 27.1194 12.8871 24.2995 8.8379C22.7462 8.0817 21.0983 7.53776 19.4 7.2207ZM12.0447 19.8588C11.4453 19.8158 10.8858 19.5422 10.4837 19.0955C10.0817 18.6487 9.86834 18.0636 9.88847 17.463C9.8653 16.8615 10.0776 16.2747 10.4803 15.8273C10.8829 15.3799 11.4442 15.1072 12.0447 15.0671C12.6453 15.1072 13.2066 15.3799 13.6092 15.8273C14.0119 16.2747 14.2242 16.8615 14.201 17.463C14.2242 18.0644 14.0119 18.6512 13.6092 19.0986C13.2066 19.546 12.6453 19.8187 12.0447 19.8588ZM19.999 19.8588C19.3995 19.8158 18.84 19.5422 18.438 19.0955C18.0359 18.6487 17.8226 18.0636 17.8427 17.463C17.8195 16.8615 18.0318 16.2747 18.4345 15.8273C18.8371 15.3799 19.3984 15.1072 19.999 15.0671C20.6006 15.1042 21.1637 15.3761 21.567 15.8241C21.9702 16.2722 22.1815 16.8607 22.1552 17.463C22.1815 18.0652 21.9702 18.6537 21.567 19.1018C21.1637 19.5499 20.6006 19.8217 19.999 19.8588Z", fill: "#050317" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip0_440_1792" },
                React__default['default'].createElement("rect", { width: "24", height: "24", fill: "white", transform: "translate(4 4.2207)" })))));
};
...
var Rights = styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
...
var Footer = function (_a) {
    ...
    return (React__default['default'].createElement(StyledFooter, null,
        React__default['default'].createElement(Container$6, null,
            React__default['default'].createElement(Logo, { href: logoLink, isFooter: true }),
            React__default['default'].createElement(RightBlock, null,
                React__default['default'].createElement(SocialLinksWrap, null, socialLinks.map(function (social) {
...
var StyledNavContainer = styled__default['default'].nav(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var Menu = function (_a) {
    var _b, _c;
    var account = _a.account, login = _a.login, logout = _a.logout, links = _a.links, socialLinks = _a.socialLinks, profile = _a.profile, children = _a.children;
    ...
    var handleOpenAccordion = React.useCallback(function (close) {
        if (close) {
    ...
    var toggleMobileMenu = React.useCallback(function () {
        seIsMobileMenuOpen(function (prev) { return !prev; });
    }, []);
    var handleMobileOverlayClick = React.useCallback(function () {
        seIsMobileMenuOpen(false);
    }, []);
    var handleMobileMenuClick = React.useCallback(function () {
        seIsMobileMenuOpen(false);
    }, []);
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { scrolled: scrolled, filledBackground: filledBackground || isMobileMenuOpen },
            React__default['default'].createElement(StyledNavContainer, null,
                ...
                isMobile ? (React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: toggleMobileMenu }, isMobileMenuOpen ? (React__default['default'].createElement(Icon$O, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$N, { width: "24px", color: "textSubtle" }))))) : (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            ...
            children,
            React__default['default'].createElement(MobileOnlyOverlay, { show: isMobileMenuOpen, onClick: handleMobileOverlayClick, role: "presentation" })),
        React__default['default'].createElement(Footer$1, { socialLinks: socialLinks, logoLink: (_c = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _c !== void 0 ? _c : "/" })));
};
var Menu$1 = React.memo(Menu);
var templateObject_1$K, templateObject_2$h, templateObject_3$8, templateObject_4$3, templateObject_5$2;
