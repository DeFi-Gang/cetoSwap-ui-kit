import React, { Children, isValidElement, cloneElement, useRef, useEffect, useState, useMemo, useReducer, useCallback, createContext, useContext, memo } from 'react';
...
var Icon$7 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 13 8" }, props),
        React.createElement("path", { d: "M1.81836 6.66699L6.81836 1.66699L11.8184 6.66699", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
};

var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 13 8" }, props),
        React.createElement("path", { d: "M11.6504 1.33301L6.65039 6.33301L1.65039 1.33301", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
};
...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 92 40" }, props),
        React.createElement("image", { width: "92", height: "40", href: "/images/logo.png" })));
};
        ...
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "white" }))),
                React.createElement(Heading, null, title)),
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", size: "sm", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$k, { color: "white", width: 24 })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = React.createElement(Icon$q, { width: isFooter ? 171 : 92 });
    return (React.createElement(React.Fragment, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://manta.socialscan.io/address/" + account, mr: "16px" }, "View on Explorer"),
...
var MobileMenuEntry = styled.div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
...
var MobileAccordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MobileMenuEntry, { onClick: handleClick, className: className },
...
var StyledAvatar = styled.div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
...
var StyledFlex = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"], ["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"])));
var MobileMenuSideBar = function (props) {
    ...
    return (React.createElement(StyledPanel, { showMenu: showMenu },
        React.createElement(MobileMenuBody, __assign({}, props)),
        React.createElement(StyledFlex, null,
            React.createElement(UserBlock, { account: account, login: login, logout: logout }),
            profile && React.createElement(Avatar, { profile: profile }))));
};
var templateObject_1$E, templateObject_2$e;

var NavHeaderEntry = styled.div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), function (_a) {
...
var AccordionContent$1 = styled.div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out, padding 0.3s ease-in;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  position: absolute;\n  z-index: 22;\n  border-radius: 4px;\n  min-width: 220px;\n  top: 50px;\n  overflow: hidden;\n  background-color: ", ";\n  padding: ", ";\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out, padding 0.3s ease-in;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  position: absolute;\n  z-index: 22;\n  border-radius: 4px;\n  min-width: 220px;\n  top: 50px;\n  overflow: hidden;\n  background-color: ", ";\n  padding: ", ";\n"])), function (_a) {
    var isOpen = _a.isOpen, maxHeight = _a.maxHeight;
    return (isOpen ? maxHeight + "px" : 0);
}, function (_a) {
    var theme = _a.theme;
...
var HeaderNav = function (_a) {
    ...
    var location = useLocation();
    var ref = useRef(null);
    var _b = useState(null), openAccordionIndex = _b[0], setOpenAccordionIndex = _b[1];
    var handleClick = useCallback(function (index, fromAccordion) {
...
var LogoFooter = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 171 74" }, props),
        React.createElement("image", { width: "171", height: "74", href: "/images/logo.png" })));
};
...
var StyledFooter = styled.footer(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  width: 100%;\n  border-top: 1px solid;\n  border-top-color: ", ";\n  background-color: ", ";\n  padding: 32px 0;\n"], ["\n  width: 100%;\n  border-top: 1px solid;\n  border-top-color: ", ";\n  background-color: ", ";\n  padding: 32px 0;\n"])), function (_a) {
    var theme = _a.theme;
...
var Container$6 = styled.div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 32px;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n    flex-direction: row;\n    justify-content: space-between;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 32px;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n    flex-direction: row;\n    justify-content: space-between;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var SocialLinksWrap = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  gap: 16px;\n"], ["\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  gap: 16px;\n"])));
var RightBlock = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 24px;\n  ", " {\n    align-items: flex-end;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 24px;\n  ", " {\n    align-items: flex-end;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var Rights = styled.div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var Docs = styled.span(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  gap: 4px;\n  font-weight: 400;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  svg {\n    fill: white;\n  }\n"], ["\n  gap: 4px;\n  font-weight: 400;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  svg {\n    fill: white;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
...
var Footer = function (_a) {
    ...
    return (React.createElement(StyledFooter, null,
        React.createElement(Container$6, null,
            React.createElement(Logo, { href: logoLink, isFooter: true }),
            React.createElement(RightBlock, null,
                React.createElement(SocialLinksWrap, null, socialLinks.map(function (social) {
                ...
                React.createElement(Docs, null,
                    React.createElement(Link, { color: "text", bold: false, external: true, href: CETO_SWAP_DOCS }, "Documents"),
                    React.createElement(CopyToClipboard, { toCopy: CETO_SWAP_DOCS })),
                React.createElement(Rights, null,
                    " \u00A9 ",
                    currentYear,
...
var Menu = function (_a) {
    ...
    var _f = useState(false), isMobileMenuOpen = _f[0], seIsMobileMenuOpen = _f[1];
    var _g = useState(false), filledBackground = _g[0], setFilledBackground = _g[1];
    ...
    var handleOpenAccordion = useCallback(function (close) {
        if (close) {
    ...
    var handleMobileOverlayClick = useCallback(function () {
        seIsMobileMenuOpen(false);
    }, []);
    var handleMobileMenuClick = useCallback(function () {
        seIsMobileMenuOpen(false);
    }, []);
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { scrolled: scrolled, filledBackground: filledBackground || isMobileMenuOpen },
            React.createElement(StyledNavContainer, null,
                ...
                isMobile ? (React.createElement(React.Fragment, null,
                    React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: toggleMobileMenu }, isMobileMenuOpen ? (React.createElement(Icon$O, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$N, { width: "24px", color: "textSubtle" }))))) : (React.createElement(React.Fragment, null,
                    React.createElement(HeaderNav, { links: links, handleOpenAccordion: handleOpenAccordion }),
